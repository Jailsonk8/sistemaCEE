...
<html>
    <head>
        <title>{{$title or 'Home Page Empresa'}}</title>
        <meta charset="utf-8">
        ...
        <div id="wrapper">
                ...
                <ul class="nav navbar-right navbar-top-links">
                    <li class="dropdown navbar-inverse">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <i class="glyphicon glyphicon-bell"></i> <b class="caret"></b>
                        </a>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        ...
                        <ul class="nav" id="side-menu">                    
                            <li>
                                <!-- link para o historico de estagios -->
                                <a href="#" class="active"><i class="glyphicon glyphicon-dashboard"></i> Contratos</a>
                            </li>
                            <li>
                                <!-- link para o historico de estagios -->
                                <a href="#" class="active"><i class="glyphicon glyphicon-eye-open"></i> Curriculos</a>
                            </li>
                        </ul>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">{{$title or "Cadastro Empresa"}}</h1>
